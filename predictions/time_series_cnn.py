...
# Loading the dataset stored localy
...
def create_dataset_windowed(features, labels, ahead=4, window_size=1, max_window_size=500):
    """
    Fuction creates a dataset for time-series analysis with window-based features.
    """
...
def PlotResults(labels, predictions, binsize=10):
    """
    Function plots the comparison between actual labels and predictions.
    """
...
def plot_history(history):
    """
    Function plots the training and validation history of the model.
    """
...
# Defining the folder path for saving results locally
folder_path = 'local_pcap_results/'
